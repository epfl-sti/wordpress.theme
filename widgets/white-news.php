    ...
    <div>
      <div class="wp-post-image-container">
        ...
        if (get_post_meta($the_post->ID)["news_has_video"][0] === "True") {
          echo '<object class="epfl-actu-video-in-new" style="width:316px; height:177px; float:none; clear:both; margin:2px auto;" data="https://www.youtube.com/embed/'.get_post_meta($the_post->ID)["youtube_id"][0].'"></object>';
        } else {
